    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/80 backdrop-blur-lg supports-[backdrop-filter]:bg-background/60">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="ghost" size="icon" onClick={() => navigate('admin-login')} className="text-muted-foreground hover:text-foreground hover:bg-muted btn-press rounded-lg hidden lg:flex">
